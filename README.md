...
- SwiftData can try to handle deeply nested structs, as long as they are Codable. Nested data will be serialized automatically. However, serialization ignores CodingKeys, custom encode methods, will try to cast types directly and will crash system instead of throwing exception.
